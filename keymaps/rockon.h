...
#define BASE \
KC_GESC,   ________________NUMBER_LEFT________________, KC_NO, KC_NO,     ________________NUMBER_RIGHT_______________, KC_MINUS, \
...
#define LOWER \
KC_TILD,   ________________NUMBER_LEFT________________, KC_NO, KC_NO,     ________________NUMBER_RIGHT_______________, KC_MINUS, \
