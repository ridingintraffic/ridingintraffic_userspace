...
#define BASE \
QK_GESC,   ________________NUMBER_LEFT________________, KC_NO, KC_NO,     ________________NUMBER_RIGHT_______________, KC_MINUS, \
QK_GESC,   _________________QWERTY_L1_________________, KC_NO, KC_NO,    _________________QWERTY_R1_________________, KC_EQUAL, \
...
#define RAISE \
KC_GRV,   ________________NUMBER_LEFT________________, KC_NO, KC_NO,     ________________NUMBER_RIGHT_______________, KC_MINUS, \
KC_GRV,   _________________RAISE_L1__________________,   KC_NO, KC_NO,     _________________RAISE_R1__________________, KC_MINUS, \
...
#define LOWER \
KC_TILDE,   ________________NUMBER_LEFT________________, KC_NO, KC_NO,     ________________NUMBER_RIGHT_______________, KC_MINUS, \
KC_TILDE,   _________________LOWER_L1__________________,  KC_NO, KC_NO,   _________________LOWER_R1__________________, KC_UNDS, \
