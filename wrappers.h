...
#define _________________QWERTY_L2_________________       MT(MOD_LCTL,KC_A), LT(2,KC_S), LT(1,KC_D),    MT(MOD_LSFT, KC_F),    KC_G
#define _________________QWERTY_L3_________________       KC_Z,    KC_X,    KC_C,    KC_V,                KC_B

#define _________________QWERTY_R1_________________       KC_Y,    KC_U,                KC_I,          KC_O,          KC_P
#define _________________QWERTY_R2_________________       KC_H,    MT(MOD_LSFT, KC_J),  LT(1,KC_K),    LT(2,KC_L),    KC_SCLN
...
#define __THUMBS_3R__            MT(MOD_MEH, KC_SPC), LT(1, KC_ENT), LT(2, KC_LALT)
